...
function LoadConfig() {
	...
	*/
	...
	Scripts.Rusher = true; // Rush bot alpha version (no questing yet, only rushing), for a list of commands, see Rusher.js
	...
	Config.PickitFiles.push("Craft.nip");		
	...
	Config.Recipes.push([Recipe.Socket.Weapon, 29]); // Crystal Sword
	Config.Recipes.push([Recipe.Socket.Weapon, 30]); // Broad Sword
	Config.Recipes.push([Recipe.Socket.Weapon, 31]); // Long Sword
	Config.Recipes.push([Recipe.Socket.Weapon, 58]); // Voulge
	Config.Recipes.push([Recipe.Socket.Weapon, 59]); // Scythe
	...
	Config.Runewords.push([Runeword.Insight, 58]); // Scythe
	Config.Runewords.push([Runeword.Insight, 59]); // Voulge
	...
	Config.Runewords.push([Runeword.Spirit, 30]); // Broad Sword
	Config.Runewords.push([Runeword.Spirit, 31]); // Long Sword
